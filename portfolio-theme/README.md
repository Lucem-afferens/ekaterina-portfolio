...
Кастомная WordPress тема для портфолио ведущей премиальных мероприятий.

## Описание

Тема разработана специально для портфолио ведущей мероприятий с полным управлением контентом через Secure Custom Fields (SCF). Тема включает все необходимые секции для презентации услуг, портфолио работ, отзывов клиентов и контактной информации.
